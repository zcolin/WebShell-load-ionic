...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        listButton.add(addButton("WebView", llContent));
        ...
        listButtonBottom.add(addButton("X5-WebView", llContentBottom));
    ...
    public void onClick(View v) {
        ...
        //            ActivityUtil.startActivity(mActivity, WebViewActivity.class, "url", "file:///android_asset/www/index.html");
        ...
        //            ActivityUtil.startActivity(mActivity, WebViewActivity.class, "url", "http://10.10.38.105:8100");
        ...
        if (v == listButton.get(0)) {
            ...
            ActivityUtil.startActivity(mActivity, X5WebViewActivity.class, "url", "file:///android_asset/www/index.html?pageName=tabs");
        }
    }
}
